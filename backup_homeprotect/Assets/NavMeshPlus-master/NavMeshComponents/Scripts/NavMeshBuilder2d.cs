...
namespace NavMeshPlus.Extensions
{
    class NavMeshBuilder2dState: IDisposable
    {
        ...
        public Dictionary<uint, Mesh> colliderMeshMap;
        ...
        public NavMeshBuilder2dState()
        {
            ...
            colliderMeshMap = new Dictionary<uint, Mesh>();
            _root = null;
        }
        ...
        public Mesh GetMesh(Collider2D collider)
        {
            ...
            if (colliderMeshMap.ContainsKey(hash))
            {
                mesh = colliderMeshMap[hash];
            }
            else
            {
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                foreach (var item in colliderMeshMap)
                {
#if UNITY_EDITOR
                    Object.DestroyImmediate(item.Value);
#else
    ...
    class NavMeshBuilder2d
    {
        ...
        {
            if (!builder.overrideByGrid && tilemap.GetColliderType(vec3int) == UnityEngine.Tilemaps.Tile.ColliderType.Sprite)
            {
